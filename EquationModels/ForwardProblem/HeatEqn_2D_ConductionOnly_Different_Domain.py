...
class EquationClass(EquationBaseClass):
    ...
    def ub1(self, t):
        type_BC = [DirichletBC()]
        u = torch.full(size=(t.shape[0], 1), fill_value=1500.0 / self.norm_temp)
        return u, type_BC
    ...
    def plotting(self, model, val_path, images_path, extrema):
        ...
        plt.setp(ax, xticks=[0, 50, 100], xticklabels=[0, 0.5, 1], yticks=[0, 50, 100], yticklabels=[0, 0.5, 1])
