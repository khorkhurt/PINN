...
# TODO: Change the equation name in the line below if you want to solve another equation


from EquationModels.ForwardProblem.Paper_Equation_model import EquationClass
